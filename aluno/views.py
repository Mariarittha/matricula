...
def curso_criar(request):
    ...
    return render(request, "aluno/formcurso.html", {'form': form})
...
def cidade_criar(request):
    ...
    return render(request, "aluno/formcidade.html", {'form': form})
...
def cidade_listar(request):
    ...
    return render(request, "aluno/cidade.html",context)
...
def cidade_remover(request, id):
    cidade = get_object_or_404(Curso, id=id)
    cidade.delete()
